...
class Google_Client {
  ...
  public function __construct($config = array()) {
    ...
    $gdwpm_apiConfig = array_merge($gdwpm_apiConfig, $config);
    self::$cache = new $gdwpm_apiConfig['cacheClass']();
    self::$auth = new $gdwpm_apiConfig['authClass']();
    self::$io = new $gdwpm_apiConfig['ioClass']();
  }
  ...
  public function addService($service, $version = false) {
    ...
    if (isset($gdwpm_apiConfig['services'][$service])) {
      // Merge the service descriptor with the default values
      $this->services[$service] = array_merge($this->services[$service], $gdwpm_apiConfig['services'][$service]);
    }
  }
  ...
  public function setApplicationName($applicationName) {
    global $gdwpm_apiConfig;
    $gdwpm_apiConfig['application_name'] = $applicationName;
  }
  ...
  public function setClientId($clientId) {
    global $gdwpm_apiConfig;
    $gdwpm_apiConfig['oauth2_client_id'] = $clientId;
  ...
  public function setClientSecret($clientSecret) {
    global $gdwpm_apiConfig;
    $gdwpm_apiConfig['oauth2_client_secret'] = $clientSecret;
  ...
  public function setRedirectUri($redirectUri) {
    global $gdwpm_apiConfig;
    $gdwpm_apiConfig['oauth2_redirect_uri'] = $redirectUri;
  ...
  public function setUseObjects($useObjects) {
    global $gdwpm_apiConfig;
    $gdwpm_apiConfig['use_objects'] = $useObjects;
  }
